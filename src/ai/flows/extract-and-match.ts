...
7.  **Generate a Standout Cover Letter:** Write a professional, concise, and compelling cover letter. It must be tailored to the job description and company. It should highlight the candidate's most relevant qualifications from the tailored resume and express genuine, well-researched interest in the role and company. The output should be a single string with markdown for formatting (e.g., newlines for paragraphs). **Do not include a markdown heading like '# Cover Letter' in the output.**
